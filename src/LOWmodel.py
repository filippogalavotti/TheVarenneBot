...
train_dataset = load_npz_to_tf_dataset("/mnt/d/Binance/low_train_data.npz") # Created by dataset_generator
test_dataset = load_npz_to_tf_dataset("/mnt/d/Binance/low_test_data.npz") # Created by dataset_generator
...
Model.save('/mnt/d/Binance/LOWModel.keras')